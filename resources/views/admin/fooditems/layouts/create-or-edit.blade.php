            ...
            <div class="col-7">
                ...
                <form action="@yield('form-action')" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="image_url">Immagine del Piatto:
                              <div class="container-span">
                                <span class="required-indicator">*</span>
                              </div>
                            </label>
                            <input type="image_url" class="form-control obligate  @error('image_url') is-invalid @enderror" id="image_url" name="image_url" value="{{ old('image_url', $foodItem->image_url) }}">
                            @error('image_url')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror 
                          </div>
